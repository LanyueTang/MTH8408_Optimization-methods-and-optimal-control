...
function plot_path(path, xrange, yrange, Z, ρ, k)
    ...
    savefig("/Users/lanyuetang/Documents/learning/MATH8408/0618增广拉格朗日/figure/QP/eq/penalty_path_iter_$k.png")
end
function plot_residuals_with_r0(grad_hist, eq_hist, r0_grad, r0_eq, εa, εr)
    ...
    # 添加参考线
    hline!([e_r0_grad], label="initial ‖∇f‖", lw=1, ls=:dashdot, color=:red)
...
function alm_with_slack()
    ...
    savefig("/Users/lanyuetang/Documents/learning/MATH8408/0618增广拉格朗日/figure/QP/eq/alm_residuals.png"); display(p)
    p2 = plot_rho_history(ρ_hist)
    savefig("/Users/lanyuetang/Documents/learning/MATH8408/0618增广拉格朗日/figure/QP/eq/rho_vs_iteration.png")
    display(p2)
